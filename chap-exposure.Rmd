...
- You might notice that the equation above is different than, for example, equation 1 from @balco2008complete, of the form $C_{mod}(T) =  \int_0^T P(t')e^{-\lambda t'}dt'$. This just because the latter refer to exposure age BP, whereas we are thinking in terms of time since exposure here.
