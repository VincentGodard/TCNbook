...
:::: {.codebox .codeimage data-latex="code"}
Below you can get all the necessary code to produce the figure
```{r eval=FALSE, class.source='fold-hide', include=TRUE, ref.label=c('dm0','dm1','dm11')}
```
::::
...
You can also explore dynamically the impact of changes in denudation rates up using this embedded application, which use the same type of code. 
